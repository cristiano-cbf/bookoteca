...
?>
  <div id="main-container" class="container-fluid edit-profile-page">
    <div class="col-md-12">
      <form action="<?= $BASE_URL ?>../controller/user_process.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div id="profile-image-container" style="background-image: url('http://localhost/projetos/bookoteca/public/img/users/<?= $userData->image ?>')"></div>
            <div class="form-group">
        ...
        <div class="col-md-4 password-section">
          ...
          <form action="<?= $BASE_URL ?>../controller/user_process.php" method="POST">
